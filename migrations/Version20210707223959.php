...
final class Version20210707223959 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_clothe (user_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', clothe_id INT NOT NULL, INDEX IDX_A6730E87A76ED395 (user_id), INDEX IDX_A6730E87D554487F (clothe_id), PRIMARY KEY(user_id, clothe_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
